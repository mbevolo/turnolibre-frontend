...
if (!window.__AUTH_BASE__) {
  // Cambiá window.APP_BASE_URL en el HTML si tu API no está en localhost:3000
  window.__AUTH_BASE__ = (window.APP_BASE_URL && String(window.APP_BASE_URL)) || 'http://localhost:3000';
}
